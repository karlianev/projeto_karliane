...
# compara se as classes sao iguais e uma das confiacas √© maior qua a confianca da iteracao atual
...
#armazena o voto do classificador para cada rÛtulo
...
#funcao self-training modificado, usa uma fÛrmula para calcular a nova taxa de confianÁa.
#inclui no conjunto dos rotulados os exemplos que possuem mesmo rotulo e taxa de conf. >= thrconf
#caso n„o exista nenhum exemplo com essa caracterÌstica, serao incluidos os exemplos que possuem o mesmo
