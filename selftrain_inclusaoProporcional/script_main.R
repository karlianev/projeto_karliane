...
acertou_g_ip <- c() #quantidade de exemplos rotulados corretamente
...
acc_g_ip <- c() #acuracia (percentual de acerto) do metodo estratificado
...
for (t in 2:2) { #1 = taxa 0,9 2 = taxa 0,95
  for(c in 1:2){  # 1 = NB, 2 = AD 3 = ripper 4 = IBK
    ...
    for(i in c(4,7,23,26,27)){  # bases de dados 4,7,23,26,27
    ...
    # data_arquivo_inclProp <- data.frame(bd_g_ip,tx_g_ip,it_g_ip,thrConf_g_ip,nr_added_exs_g_ip, acertou_g_ip)
    ...
    data_arquivo_inclProp <- data.frame(bd_g_ip,tx_g_ip,it_g_ip,thrConf_g_ip,nr_added_exs_g_ip)
    
    
    data_arquivo_acc_modif2 <- data.frame(tx, bd, acc_g)
    data_arquivo_acc_modif3 <- data.frame(tx, bd, acc_g_3)
    data_arquivo_acc_inclProp <- data.frame(tx, bd, acc_g_ip)
    ...
    if (t == 1){ #TAXA 0.9
      if (c==1){ #NB
        ...
        write.csv(data_arquivo_inclProp, "resultado_inclProp_nb_09.csv", row.names = FALSE)
        write.csv(data_arquivo_acc_por_taxa_inclProp, "resultado_acc_inclProp_nb_09.csv", row.names = FALSE)
        ...
        write.csv(data_arquivo_inclProp, "resultado_inclProp_ad_09.csv", row.names = FALSE)
        write.csv(data_arquivo_acc_por_taxa_inclProp, "resultado_acc_inclProp_ad_09.csv", row.names = FALSE)
        ...
        write.csv(data_arquivo_inclProp, "resultado_inclProp_rip_09.csv", row.names = FALSE)
        write.csv(data_arquivo_acc_por_taxa_inclProp, "resultado_acc_inclProp_rip_09.csv", row.names = FALSE)
        ...
        write.csv(data_arquivo_inclProp, "resultado_inclProp_ibk_09.csv", row.names = FALSE)
        write.csv(data_arquivo_acc_por_taxa_inclProp, "resultado_acc_inclProp_ibk_09.csv", row.names = FALSE)
      ...
      if (c==1){ #NB
        ...
        write.csv(data_arquivo_inclProp, "resultado_inclProp_ad_095.csv", row.names = FALSE)
        write.csv(data_arquivo_acc_por_taxa_inclProp, "resultado_acc_inclProp_ad_095.csv", row.names = FALSE)
        ...
        write.csv(data_arquivo_inclProp, "resultado_inclProp_rip_095.csv", row.names = FALSE)
        write.csv(data_arquivo_acc_por_taxa_inclProp, "resultado_acc_inclProp_rip_095.csv", row.names = FALSE)
        ...
        write.csv(data_arquivo_inclProp, "resultado_inclProp_ibk_095.csv", row.names = FALSE)
        write.csv(data_arquivo_acc_por_taxa_inclProp, "resultado_acc_inclProp_ibk_095.csv", row.names = FALSE)
