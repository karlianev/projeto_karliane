...
}else if ((method==8)||(method==9)||(method==10)){ # modificado add os novos metodos
  co_training <- coTrainingFlexConCS(my_learner, my_function, base1, base2, limiar1,limiar2, method, qtd_exem_menor_classe)
