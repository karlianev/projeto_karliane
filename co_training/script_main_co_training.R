...
num_metodo <- 4 # 0=original 1 = gradativo_soma 2= gradativo_voto 3=flexcon_soma (treinamento_flexcon setar votacao = false) 4=flexcon_voto (treinamento_flexcon setar votacao = true) 5=flexcon-C1_soma (treinamento_flexcon_c1 setar votacao = false) 6=flexcon-C1_voto (treinamento_flexcon_c1 setar votacao = true) 7=flexcon-C2
conj_treino <- c()
