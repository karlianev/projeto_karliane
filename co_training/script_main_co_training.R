...
num_metodo <- 6 # 0=original 1 = gradativo_soma 2= gradativo_voto 3=flexcon_soma (treinamento_flexcon setar votacao = false) 4=flexcon_voto (treinamento_flexcon setar votacao = true) 5=flexcon-C1_soma (treinamento_flexcon_c1 setar votacao = false) 6=flexcon-C1_voto (treinamento_flexcon_c1 setar votacao = true) 7=flexcon-C2
conj_treino <- c()
    ...
    if (t == 1){ #TAXA 0.9
      if (c==1){
        ...
        if (metodo==1){ # 1=original 2= gradativo 3=flexcon_soma 4=flexcon_voto 5=flexcon-C1_soma 6=flexcon-C1_voto 7=flexcon-C2
          ...
          write.csv(data_arquivo_acc_por_taxa_o, "resultado_acc_JRip_flexcon_c1_soma_09.csv", row.names = FALSE)
        }else if (metodo==6){
          #escrever no arquivo NB
