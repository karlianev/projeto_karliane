...
selfTrainingFlexCon <- function (learner, predFunc, data1, votacao = T) {
  conf_media <- 0
  form <- as.formula(paste(classe,'~', '.'))
  thrConf1 <- 0.95
  # thrConf2 <- 0.95
...
#               6- FlexConC1v
#               7- FlexConC2
selfTrainingFlexConC <- function(learner, predFunc, data1, limiar1, method, min_exem_por_classe){#inicializar vatacao?
